...
#ifndef __vtkMessageCollection_h
#define __vtkMessageCollection_h
...
/// replaced by that.
class vtkMessageCollection : public vtkObject
{
public:
  vtkTypeMacro(vtkMessageCollection,vtkObject);
  void PrintSelf(ostream& os, vtkIndent indent) override;
  static vtkMessageCollection* New();
  ...
  virtual void AddMessages(vtkMessageCollection* source, const std::string& prefix=std::string());

  /// Clear the message vector.
  virtual void ClearMessages();

  /// Copy all messages from another collection.
  virtual void DeepCopy(vtkMessageCollection* source);
...
protected:
  ...
  ~vtkMessageCollection() override;
  vtkMessageCollection(const vtkMessageCollection&);
  void operator=(const vtkMessageCollection&);
