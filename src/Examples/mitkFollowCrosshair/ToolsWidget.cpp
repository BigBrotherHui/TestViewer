...
ToolsWidget::ToolsWidget(QWidget *parent)
  ...
  connect(mUi->pushButton, &QPushButton::clicked, this, &ToolsWidget::on_pushButton_clicked);
}
...
{
    mUi->stackedWidget->setCurrentIndex((mUi->stackedWidget->currentIndex() + 1) % mUi->stackedWidget->count());
}
