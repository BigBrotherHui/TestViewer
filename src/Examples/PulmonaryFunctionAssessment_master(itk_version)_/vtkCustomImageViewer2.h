...
class vtkCustomImageViewer2 : public vtkObject
{
public:
  static vtkCustomImageViewer2* New();
  vtkTypeMacro(vtkCustomImageViewer2, vtkObject);
  ...
  {
    this->SetSliceOrientation(vtkCustomImageViewer2::SLICE_ORIENTATION_XY);
  }
  virtual void SetSliceOrientationToYZ()
  {
    this->SetSliceOrientation(vtkCustomImageViewer2::SLICE_ORIENTATION_YZ);
  }
  virtual void SetSliceOrientationToXZ()
  {
    this->SetSliceOrientation(vtkCustomImageViewer2::SLICE_ORIENTATION_XZ);
  }
...
protected:
    vtkCustomImageViewer2();
  ~vtkCustomImageViewer2() override;
...
private:
    vtkCustomImageViewer2(const vtkCustomImageViewer2&) = delete;
  void operator=(const vtkCustomImageViewer2&) = delete;
};