/*=========================================================================
  ...
  Module:    PointHandleRepresentation3D.h
...
=========================================================================*/
/**
 * @class   PointHandleRepresentation3D
...
class PointHandleRepresentation3D : public vtkHandleRepresentation
{
public:
  /**
   * Instantiate this class.
   */
  static PointHandleRepresentation3D* New();

  ///@{
  /**
   * Standard methods for instances of this class.
   */
  vtkTypeMacro(PointHandleRepresentation3D, vtkHandleRepresentation);
...
protected:
  PointHandleRepresentation3D();
  ~PointHandleRepresentation3D() override;
...
private:
  PointHandleRepresentation3D(const PointHandleRepresentation3D&) = delete;
  void operator=(const PointHandleRepresentation3D&) = delete;
};
