/*=========================================================================
  ...
  Module:    SphereHandleRepresentation.h
...
=========================================================================*/
/**
 * @class   SphereHandleRepresentation
...
#ifndef SphereHandleRepresentation_h
#define SphereHandleRepresentation_h
...
class SphereHandleRepresentation : public vtkHandleRepresentation
{
public:
  /**
   * Instantiate this class.
   */
  static SphereHandleRepresentation* New();

  ///@{
  /**
   * Standard methods for instances of this class.
   */
  vtkTypeMacro(SphereHandleRepresentation, vtkHandleRepresentation);
...
protected:
  ...
  ~SphereHandleRepresentation() override;

  // the cursor3D
  vtkActor* Actor;
  vtkPolyDataMapper* Mapper;
  vtkRegularPolygonSource* Sphere;
...
private:
  SphereHandleRepresentation(const SphereHandleRepresentation&) = delete;
  void operator=(const SphereHandleRepresentation&) = delete;
};
