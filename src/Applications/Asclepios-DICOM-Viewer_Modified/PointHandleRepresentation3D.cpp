/*=========================================================================
  ...
  Module:    PointHandleRepresentation3D.cxx
...
vtkStandardNewMacro(PointHandleRepresentation3D);

vtkCxxSetObjectMacro(PointHandleRepresentation3D, Property, vtkProperty);
vtkCxxSetObjectMacro(PointHandleRepresentation3D, SelectedProperty, vtkProperty);

//------------------------------------------------------------------------------
PointHandleRepresentation3D::PointHandleRepresentation3D()
{
  // Initialize state
...
//------------------------------------------------------------------------------
void PointHandleRepresentation3D::RegisterPickers()
{
...
//------------------------------------------------------------------------------
void PointHandleRepresentation3D::PlaceWidget(double bds[6])
{
  int i;
...
//------------------------------------------------------------------------------
double* PointHandleRepresentation3D::GetBounds()
{
  return this->Cursor3D->GetModelBounds();
}

//------------------------------------------------------------------------------
void PointHandleRepresentation3D::SetWorldPosition(double p[3])
{
...
//------------------------------------------------------------------------------
void PointHandleRepresentation3D::SetDisplayPosition(double p[3])
{
  if (this->Renderer && this->PointPlacer)
  {
...
//------------------------------------------------------------------------------
void PointHandleRepresentation3D::SetHandleSize(double size)
{
...
//------------------------------------------------------------------------------
int PointHandleRepresentation3D ::ComputeInteractionState(int X, int Y, int vtkNotUsed(modify))
{
    this->VisibilityOn();
...
//------------------------------------------------------------------------------
int PointHandleRepresentation3D::ComputeComplexInteractionState(
...
//------------------------------------------------------------------------------
int PointHandleRepresentation3D::DetermineConstraintAxis(
...
void PointHandleRepresentation3D::StartWidgetInteraction(double startEventPos[2])
{
...
//------------------------------------------------------------------------------
void PointHandleRepresentation3D::StartComplexInteraction(
...
// of the widget.
void PointHandleRepresentation3D::WidgetInteraction(double eventPos[2])
{
...
void PointHandleRepresentation3D::ComplexInteraction(
  vtkRenderWindowInteractor*, vtkAbstractWidget*, unsigned long, void* calldata)
{
  vtkEventData* edata = static_cast<vtkEventData*>(calldata);
  vtkEventDataDevice3D* edd = edata->GetAsEventDataDevice3D();
...
//------------------------------------------------------------------------------
void PointHandleRepresentation3D ::MoveFocusRequest(
...
//------------------------------------------------------------------------------
void PointHandleRepresentation3D::MoveFocus(const double* p1, const double* p2)
{
  this->Translate(p1, p2);
}

//------------------------------------------------------------------------------
void PointHandleRepresentation3D::SetTranslationMode(vtkTypeBool mode)
{
...
void PointHandleRepresentation3D::Translate(const double* p1, const double* p2)
{
  double v[3] = { 0, 0, 0 };
...
//------------------------------------------------------------------------------
void PointHandleRepresentation3D::SizeBounds()
{
...
//------------------------------------------------------------------------------
void PointHandleRepresentation3D::Scale(
...
//------------------------------------------------------------------------------
void PointHandleRepresentation3D::Highlight(int highlight)
{
  if (highlight)
  {
...
//------------------------------------------------------------------------------
void PointHandleRepresentation3D::CreateDefaultProperties()
{
...
//------------------------------------------------------------------------------
void PointHandleRepresentation3D::SetVisibility(vtkTypeBool visible)
{
...
//------------------------------------------------------------------------------
void PointHandleRepresentation3D::BuildRepresentation()
{
...
//------------------------------------------------------------------------------
void PointHandleRepresentation3D::ShallowCopy(vtkProp* prop)
{
  PointHandleRepresentation3D* rep = PointHandleRepresentation3D::SafeDownCast(prop);
  if (rep)
  {
...
//------------------------------------------------------------------------------
void PointHandleRepresentation3D::DeepCopy(vtkProp* prop)
{
  PointHandleRepresentation3D* rep = PointHandleRepresentation3D::SafeDownCast(prop);
  if (rep)
  {
...
//------------------------------------------------------------------------------
void PointHandleRepresentation3D::GetActors(vtkPropCollection* pc)
{
  this->Actor->GetActors(pc);
}

//------------------------------------------------------------------------------
void PointHandleRepresentation3D::ReleaseGraphicsResources(vtkWindow* win)
{
  this->Actor->ReleaseGraphicsResources(win);
}

//------------------------------------------------------------------------------
int PointHandleRepresentation3D::RenderOpaqueGeometry(vtkViewport* viewport)
{
...
//------------------------------------------------------------------------------
int PointHandleRepresentation3D::RenderTranslucentPolygonalGeometry(vtkViewport* viewport)
{
  this->BuildRepresentation();
...
//------------------------------------------------------------------------------
vtkTypeBool PointHandleRepresentation3D::HasTranslucentPolygonalGeometry()
{
  this->BuildRepresentation();
...
//------------------------------------------------------------------------------
void PointHandleRepresentation3D::PrintSelf(ostream& os, vtkIndent indent)
{
