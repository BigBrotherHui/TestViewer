/*=========================================================================
  ...
  Module:    SphereHandleRepresentation.cxx
...
vtkStandardNewMacro(SphereHandleRepresentation);
vtkCxxSetObjectMacro(SphereHandleRepresentation, SelectedProperty, vtkProperty);

//------------------------------------------------------------------------------
SphereHandleRepresentation::SphereHandleRepresentation()
{
  // Initialize state
  this->InteractionState = vtkHandleRepresentation::Outside;

  // Represent the line
  this->Sphere = vtkRegularPolygonSource::New();
  this->Sphere->SetNumberOfSides(70);
...
//------------------------------------------------------------------------------
void SphereHandleRepresentation::RegisterPickers()
{
...
//------------------------------------------------------------------------------
void SphereHandleRepresentation::PlaceWidget(double bds[6])
{
  int i;
...
//------------------------------------------------------------------------------
void SphereHandleRepresentation::SetSphereRadius(double radius)
{
...
//------------------------------------------------------------------------------
double SphereHandleRepresentation::GetSphereRadius()
{
  return this->Sphere->GetRadius();
}

//------------------------------------------------------------------------------
double* SphereHandleRepresentation::GetBounds()
{
...
//------------------------------------------------------------------------------
void SphereHandleRepresentation::SetWorldPosition(double p[3])
{
...
//------------------------------------------------------------------------------
void SphereHandleRepresentation::SetDisplayPosition(double p[3])
{
...
//------------------------------------------------------------------------------
void SphereHandleRepresentation::SetHandleSize(double size)
{
...
//------------------------------------------------------------------------------
int SphereHandleRepresentation::ComputeInteractionState(int X, int Y, int vtkNotUsed(modify))
{
...
void SphereHandleRepresentation::StartWidgetInteraction(double startEventPos[2])
{
...
// of the widget.
void SphereHandleRepresentation::WidgetInteraction(double eventPos[2])
{
...
/*
//------------------------------------------------------------------------------
void SphereHandleRepresentation::MoveFocus(const double *p1, const double *p2)
{
...
void SphereHandleRepresentation::Translate(const double *p1, const double *p2)
{
  //Get the motion vector
  double v[3];
  v[0] = p2[0] - p1[0];
...
//------------------------------------------------------------------------------
void SphereHandleRepresentation::SizeBounds()
{
  double center[3];
  this->Sphere->GetCenter(center);
...
//------------------------------------------------------------------------------
void SphereHandleRepresentation::Scale(
...
//------------------------------------------------------------------------------
void SphereHandleRepresentation::Highlight(int highlight)
{
  if (highlight)
  {
...
//------------------------------------------------------------------------------
void SphereHandleRepresentation::CreateDefaultProperties()
{
...
//------------------------------------------------------------------------------
void SphereHandleRepresentation::BuildRepresentation()
{
...
//------------------------------------------------------------------------------
void SphereHandleRepresentation::ShallowCopy(vtkProp* prop)
{
  SphereHandleRepresentation* rep = SphereHandleRepresentation::SafeDownCast(prop);
  if (rep)
  {
...
//------------------------------------------------------------------------------
void SphereHandleRepresentation::DeepCopy(vtkProp* prop)
{
  SphereHandleRepresentation* rep = SphereHandleRepresentation::SafeDownCast(prop);
  if (rep)
  {
...
//------------------------------------------------------------------------------
void SphereHandleRepresentation::GetActors(vtkPropCollection* pc)
{
  this->Actor->GetActors(pc);
}

//------------------------------------------------------------------------------
void SphereHandleRepresentation::ReleaseGraphicsResources(vtkWindow* win)
{
  this->Actor->ReleaseGraphicsResources(win);
}

//------------------------------------------------------------------------------
int SphereHandleRepresentation::RenderOpaqueGeometry(vtkViewport* viewport)
{
...
//------------------------------------------------------------------------------
int SphereHandleRepresentation ::RenderTranslucentPolygonalGeometry(vtkViewport* viewport)
{
  this->BuildRepresentation();
...
//------------------------------------------------------------------------------
vtkTypeBool SphereHandleRepresentation::HasTranslucentPolygonalGeometry()
{
  return 0; // this->Actor->HasTranslucentPolygonalGeometry();
}

//------------------------------------------------------------------------------
void SphereHandleRepresentation::SetProperty(vtkProperty* p)
{
...
//------------------------------------------------------------------------------
void SphereHandleRepresentation::SetVisibility(vtkTypeBool visible)
{
...
//------------------------------------------------------------------------------
void SphereHandleRepresentation::PrintSelf(ostream& os, vtkIndent indent)
{
